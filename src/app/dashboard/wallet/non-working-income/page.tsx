...
const incomeData = [
    { sNo: 1, type: 'Level Completion Bonus', date: '2024-07-28', amount: 500.00 },
    { sNo: 2, type: 'Royalty Income', date: '2024-07-27', amount: 150.00 },
    { sNo: 3, type: 'Referral Splash', date: '2024-07-26', amount: 75.00 },
];

export default function NonWorkingIncomePage() {
      ...
      <main className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8">
        ...
        <Card>
            <CardHeader>
                ...
                <CardDescription>A list of your non-working income.</CardDescription>
            </CardHeader>
            <CardContent>
                <Table>
                    <TableHeader>
