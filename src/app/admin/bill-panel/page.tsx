  ...
  return (
    <div className="flex min-h-screen w-full flex-col relative bg-background">
      ...
      <main className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2"><Receipt className="h-6 w-6" />Manage Bills</CardTitle>
            <CardDescription>This page is under construction. You will be able to manage bills and invoices from here.</CardDescription>
          </CardHeader>
          <CardContent>
            <p>Coming soon...</p>
          </CardContent>
